...
const requiredColumns = {
  ...
  download_tokens: ["id", "tokenHash", "orderId", "orderItemId", "userId", "email", "expiresAt", "consumedAt", "createdAt"],
  email_logs: ["id", "order_id", "customer_email", "template", "status", "provider_response", "error_message", "created_at"],
...
const requiredPolicies = [
  ...
  "download_tokens_service_role_all",
  "email_logs_admin_select",
  "email_logs_service_role_insert",
...
const requiredIndexes = [
  ...
  "download_tokens_order_item_idx",
  "email_logs_order_id_idx",
